...
insert  into `classes`(`classId`,`teacherId`,`courseId`,`description`,`courseOutline`,`image`) values (1,1,1,'sdlsakdasdsakjldkasdas\ndlasdjadlasdkjasldsakdjas\nsadlakdajsdlada','adaasasdxzcxzczxcm\nxzclkzcxjzlcxz\nxzlcjzcnzxckzx\nxzcljzxczxckz\nxzlcjxzczxc\nzxlczxn','image/1450431180.jpg'),(3,1,3,NULL,NULL,'image/1450431077.jpg'),(4,1,4,NULL,NULL,'image/1450431077.jpg'),(5,1,5,NULL,NULL,'image/1450431077.jpg'),(6,4,2,NULL,NULL,'image/1450431077.jpg'),(7,4,3,NULL,NULL,'image/1450431077.jpg'),(8,4,6,NULL,NULL,'image/1450431077.jpg'),(10,4,1,'newos','newsoso','image/1450431077.jpg'),(11,4,1,'newos','newsoso','image/1450431077.jpg'),(12,1,3,'aa','aa','image/1450431077.jpg'),(14,1,3,'aa','aa','image/1450431180.jpg'),(19,4,4,'sdasljdh','sdlksdj','image/1450432345.jpg'),(22,1,6,'abc','abc','image/1450506759'),(23,2,5,'avc','aed','image/1450538464');
...
insert  into `person`(`id`,`fname`,`lname`,`phone`,`email`,`password`,`birthdate`,`type`,`userImg`,`intro`) values (1,'momna','aslam',123,'momna@yahoo.com','pk','0000-00-00',1,NULL,NULL),(2,'hisham','asghar',26546,'bc23@pucit.edu','pk','0000-00-00',0,NULL,NULL),(3,'tayyab','tariq',49213,'bcs54@pucit.edu','pk','0000-00-00',0,'',NULL),(4,'aleena','raza',2147483647,'bcs53@pucit.edu','pk','0000-00-00',1,NULL,NULL),(5,'haider','ali',1321654987,'haidex.ali@yahoo.com','pk','0000-00-00',0,'',NULL);
...
insert  into `student`(`studentId`,`classId`) values (2,1),(2,2),(2,3),(2,4),(3,1),(3,3),(4,1);
...
insert  into `ta`(`studentId`,`classId`) values (2,1),(2,6),(2,22),(3,2),(3,6),(5,22);
...
insert  into `teacher`(`teacherId`,`classId`) values (1,1),(1,2),(1,3),(1,4),(1,5),(1,22),(2,3),(2,23),(2,24),(2,25);

                    ...
                    <div id="Posts" class="sub_main_content sub_child_content" >
                        ...
                        <div id="new_post" class="new_post">
                            ...
                            if(isset($_REQUEST["Post"]) == true){
                                $d = $_REQUEST['pt'];
                                $sql = "insert into post(postedBy,postDesc,courseId,teacherId) values ($u,'$d',$c,$u);";
                                $res = $db->query($sql);
                            }
                            ?>
                            <form>
                        ...
                        <div id="old_posts" class="post_wrapper">
                            <?php
        $sql = 'select concat(fname," ",lname) as name,postDesc,files,postTime from post,person where postedBy=person.id and courseId = '.$c.' and teacherId = '.$u.' order by postTime desc;';
